...
import com.ravn.ravn_challenge_v2_jose_arteaga.databinding.ItemDualTextBinding
import com.ravn.ravn_challenge_v2_jose_arteaga.databinding.ItemHeaderBinding
import com.ravn.ravn_challenge_v2_jose_arteaga.databinding.ItemSingleTextBinding
        ...
        when (viewType) {
            ...
            DetailViewType.ATRIBUTE.value -> {
                DoubleTextViewHolder(
                    LayoutInflater.from(parent.context).inflate(
                        R.layout.item_dual_text, parent, false
                    )
                )
            }
            else -> {
                SingleTextViewHolder(
                    LayoutInflater.from(parent.context).inflate(
                        R.layout.item_single_text, parent, false
                    )
                )
            }
        }
